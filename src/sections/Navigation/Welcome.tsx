...
const Navigation: React.FC = () => (
  <nav id="js--nav" className="nav">
    <p className="nav__title">Wanna learn more what I can do?</p>
    <div className="nav__content">
      <ul className="nav__links">
        <li>
          <a className="js--nav-link nav__link" href="#about">
            about
          </a>
        </li>
        <li>
          <a className="js--nav-link nav__link" href="#skills">
            skills
          </a>
        </li>
        <li>
          <a className="js--nav-link nav__link" href="#career">
            career
          </a>
        </li>
      </ul>
      ...
      <ul className="nav__links">
        <li>
          <a className="js--nav-link nav__link" href="#projects">
            projects
          </a>
        </li>
        <li>
          <a className="js--nav-link nav__link" href="#contacts">
            contacts
          </a>
        </li>
        <li>
          <a className="js--nav-link nav__link" href="#cv">
            cv
          </a>
        </li>
      </ul>
